...
<html lang="en" >
    ...
    %>
    <body>
        <h1 align="center" id="heading">Student Payment Report</h1>
        <table class="table table-striped table-bordered " cellspacing="0" width="100%" id="example">
                ...
                <%
                    ...
                    sview = "select * from tbl_request re inner join tbl_student st on re.student_id=st.student_id  inner join tbl_intership i on re.internship_id=i.internship_id";
