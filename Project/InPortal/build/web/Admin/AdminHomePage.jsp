            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left">
							<div class="logo-name">
									 <a href="index.html"><h1> <i class="fa fa-linkedin" aria-hidden="true"></i>Portal</h1> 
				...
				<div class="market-update-block clr-block-2">
				 <div class="col-md-8 market-update-left">
				  ...
				  <div class="clearfix"> </div>
                                        ...
                                        <a href="CompanyRequestFrame.jsp"><div class="col-md-4 market-update-gd">
				<div class="market-update-block clr-block-3">
					<div class="col-md-8 market-update-left">
                                              <%
                                         String select3="select count(*) as Total3 from tbl_makerequest where isactive='0'";
                                         ResultSet res3=con.selectCommand(select3);
                                         res3.next();
                                         %>
                                            <h3 class="counter"><%=res3.getString("Total3")%></h3>
						<h4>New Messages</h4>
						<p>Other hand, we denounce</p>
					</div>
					<div class="col-md-4 market-update-right">
...
<div class="copyrights">
	 <p>© 2022 InPortal. All Rights Reserved | Design by  <a href="#" target="_blank">Georgekutty</a> </p>
</div>	
		      ...
		      <ul id="menu" >
		        ...
		        <li id="menu-comunicacao" ><a href="#"><i class="fa fa-book nav_icon"></i><span>Register</span><span class="fa fa-angle-right" style="float: right"></span></a>
		          <ul id="menu-comunicacao-sub" >
		            <li id="menu-mensagens" style="width: 120px" ><a href="CompanySector.jsp">Company Sector</a>		              
		            </li>
		          ...
		          <ul id="menu-comunicacao-sub" >
		            <li id="menu-mensagens" style="width: 120px" ><a href="CompanyApproval.jsp">Company Approval</a>		              
		            </li>
		          ...
		          <ul id="menu-academico-sub" >
		            ...
		            <li id="menu-academico-avaliacoes" ><a href="Report2Frame.jsp">Report 2</a></li>	
                             <li id="menu-academico-avaliacoes" ><a href="Report3Frame.jsp">Report 3</a></li>	
                               <li id="menu-academico-avaliacoes" ><a href="Report4Frame.jsp">Report 3</a></li>	
		          </ul>
		        </li>
