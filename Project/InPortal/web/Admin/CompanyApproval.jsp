...
.btn-success {
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
         <%
                    String name=rs.getString("company_address");
                    String address[]=name.split(",");
                    
                    %>
        <p class="fw-normal mb-1"><%=address[0]%></p>
        <p class="text-muted mb-0"><%=address[1]%></p>
         <p class="text-muted mb-0"><%=address[2]%></p>
          <p class="text-muted mb-0"><%=address[3]%></p>
           <p class="text-muted mb-0"><%=address[4]%></p>
