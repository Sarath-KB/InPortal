<%-- 
    Document   : ReportChart
    Created on : 21 Dec, 2021, 10:26:49 PM
    Author     : hp
--%>
...
<html lang="en" >
    ...
    %>
    <body>
        <h1 align="center" id="heading">Student Count Report</h1>
...
<!--                    <th scope="col">Number of Company</th>-->
            ...
            <tbody>
                <%                    while (rs1.next()) {
                        String sviews = "select count(distinct(student_id)) as Student_Count from tbl_request r inner join tbl_intership i on i.internship_id=r.internship_id inner join tbl_company c on c.company_id=i.company_id where sector_id='"+rs1.getString("sector_id")+"' ";

                        ResultSet rsc = con.selectCommand(sviews);
                        if (rsc.next()) {
                            i++;
                %> 
